...
const Roadmaps = () => {
  const [localSelectedRoadmap, setLocalSelectedRoadmap] = useState<string | null>(null);
  ...
  const handleRoadmapSelect = (roadmapId: string) => {
    ...
    if (roadmap) {
      setSelectedRoadmap(roadmapId, roadmap);
      setLocalSelectedRoadmap(roadmapId);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {localSelectedRoadmap ? (
          // Detailed Roadmap View
          <div className="animate-fade-in">
            <div className="flex items-center justify-between mb-8">
              <Button 
                variant="outline" 
                onClick={() => setLocalSelectedRoadmap(null)}
                className="mb-4"
              >
                ← Back to Roadmaps
              </Button>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 animate-slide-up">
            {roadmaps.map((roadmap) => (
              <div 
                ...
                onClick={() => roadmap.id === 'web-dev' && handleRoadmapSelect(roadmap.id)}
              >
                {/* Icon and Progress */}
