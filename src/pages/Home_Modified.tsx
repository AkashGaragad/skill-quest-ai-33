            ...
            <div className="text-center lg:text-left space-y-6 animate-fade-in">
              ...
              {selectedRoadmap && (
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
                  <p className="text-white/80 text-sm mb-2">Currently focused on:</p>
                  <p className="text-white font-semibold">{selectedRoadmap.title}</p>
                </div>
              )}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-card rounded-2xl p-6 shadow-soft border border-border">
              ...
              <div className="space-y-3">
                {(selectedRoadmap ? [
                  { action: `Continue ${selectedRoadmap.title}`, time: "5 minutes ago", type: "info" },
